...
const IconButton: React.FC<IconButtonProps> = ({ 
  ...
  const baseClasses = 'inline-flex items-center justify-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed border [&_svg]:transition-colors [&_svg]:duration-200';
