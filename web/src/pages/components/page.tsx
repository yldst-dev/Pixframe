  ...
  return (
    <div className="min-h-screen bg-background p-8 font-sans">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* Sliders Section */}
        <section className="space-y-6">
          <h2 className="text-xl font-bold uppercase border-l-4 border-primary pl-3">Sliders</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 border border-border bg-card space-y-8">
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="font-medium">Basic Slider (0-100)</span>
                  <span className="font-mono text-muted-foreground">{sliderValue1}</span>
                </div>
                <Slider 
                  value={sliderValue1} 
                  min={0} 
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="font-medium">Decimal Step (0.0-1.0)</span>
                  <span className="font-mono text-muted-foreground">{sliderValue2}</span>
                </div>
                <Slider 
                  value={sliderValue2} 
                  min={0} 
